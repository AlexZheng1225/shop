$(function () {
    ...
    var pageSize = 4;
    // 获取店铺列表的URL
    var listUrl = '/onlineshop/frontend/listshops';
    // 获取店铺类别列表以及区域列表的URL
    var searchDivUrl = '/onlineshop/frontend/listshopspageinfo';
    // 页码
    var pageNum = 1;
    ...
    $('.shop-list').on('click', '.card', function (e) {
        ...
        window.location.href = '/onlineshop/frontend/shopdetail?shopId=' + shopId;
    });
